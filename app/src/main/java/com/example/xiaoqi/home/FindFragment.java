...
public class FindFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragment_find,//内容页面的布局文件
                container,//根视图对象
                false);//false表示需要手动调用addView方法将view添加到container中,true表示自动调用addView方法
        //在哪里加载文件，就在哪里获取内容页面当中控件的引用
        gvNotes = view.findViewById(R.id.gv_find_notes);
        //获取Activity传来的Bundle数据
        noteList = (ArrayList<Note>) getArguments().getSerializable("findNoteList");
