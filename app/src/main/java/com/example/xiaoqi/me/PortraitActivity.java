...
public class PortraitActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (fileIsExists(avatarStr)) {
            ...
            ivPortraitimg.setImageBitmap(avatar);
        } else {
            ivPortraitimg.setImageResource(R.drawable.avatardefault1);
        }
        ...
        ivBacktome1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent1.setClass(PortraitActivity.this,MeActivity.class);
...
//            }
            switch(requestCode){
                ...
                case 103:
                    ...
                    try {
                        ...
                        ivPortraitimg.setImageURI(originalUri);
    ...
    public File saveImage(Bitmap bmp) throws MalformedURLException {
        ...
        String fileName = global.getCurrentUserPhone() + ".jpg";
